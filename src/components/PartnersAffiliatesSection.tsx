...
export const PARTNERS_AFFILIATES_DATA: PartnerAffiliateItem[] = [
  ...
  },
  {
    ...
    category: 'Kibernetička Sigurnost & Antivirus',
    badge: 'ZVANIČNI PARTNER • POPUST 🛡️',
    badgeType: 'teal',
    description: 'Vrhunska digitalna sigurnost, antivirusna zaštita u stvarnom vremenu, zaštita online plaćanja i privatnosti od modernih cyber prijetnji.',
    highlight: 'Poseban popust na licence i instalaciju',
    affiliateUrl: 'https://dhwnh.com/g/f6b07970c6fe02eff231e5a65aad3ad5ea3e5afd/?erid=5jtCeReLm1S3Xx3LfA8QF84',
    buttonLabel: 'Aktiviraj Popust',
    icon: ShieldCheck,
    logoUrl: 'https://archive.org/download/kaspersky-affiliated-promo/Kaspersky_affiliated_promo.jpg',
    brandInitials: 'K',
    brandColor: '#00A88E',
    accentBorderColor: 'hover:border-[#00A88E]',
    bgGradient: 'from-[#00A88E]/10 to-transparent'
  },
  {
    id: 'rzekl',
